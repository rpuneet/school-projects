...
horline3=Line(Point(300,350),Point(350,350))
horline3.setWidth(5)
horline3.draw(win)

horline4=Line(Point(300,550),Point(350,550))
horline4.setWidth(5)
horline4.draw(win)


horline5=Line(Point(650,350),Point(700,350))
horline5.setWidth(5)
horline5.draw(win)

horline6=Line(Point(650,550),Point(700,550))
horline6.setWidth(5)
horline6.draw(win)
...
goal=Rectangle(Point(250,600),Point(300,650))
goal.setFill('green')
goal.setWidth(5)
goal.draw(win)
...
def set_lim(movedir):
    ...
    cury=ball.getCenter().getY()
    if(movedir=='u'):
        if (((curx>300 and curx<350) or (curx>650 and curx<700))and cury>550):
            limy=550
            return limy
        elif (((curx>300 and curx<350) or (curx>650 and curx<700))and cury<550 and cury>350):
            limy=350
            return limy
        else:
            limy=200
    ...
    if(movedir=='d'):
        if (((curx>300 and curx<350) or (curx>650 and curx<700))and cury<350):
            limy=350
            return limy
        elif (((curx>300 and curx<350) or (curx>650 and curx<700))and cury<550 and cury>350):
            limy=550
...
while(True):
    ...
    curx=ball.getCenter().getX()
    cury=ball.getCenter().getY()
    if (curx>250 and curx<300 and cury<650 and cury>600):
        break
print('You Win')
